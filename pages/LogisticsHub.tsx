  ...
  return (
    <div className="p-6 max-w-7xl mx-auto animate-fade-in pb-20">
      <div className="mb-8 flex justify-between items-end">
        <div>
           <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Logistics Hub</h1>
           <p className="text-slate-500 text-sm mt-1">Regional supply chain & PLB operations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
           ...
           <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-4">
              <h3 className="font-bold text-xs text-slate-500 uppercase mb-3 flex items-center gap-2"><Truck size={14} /> In-Transit Cargo</h3>
              {activeTransfers.length === 0 ? (
                 <p className="text-xs text-slate-400 italic">No active shipments.</p>
              ) : (
                       ...
                       return (
                          <div key={t.id} className="p-3 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-100 dark:border-slate-700">
                             ...
                             <div className="flex items-center gap-1 text-[10px] text-slate-500 mb-2">
                                <ArrowRight size={10} /> To: {targetName}
                             </div>
        ...
        <div className="lg:col-span-3 space-y-6">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between h-28 relative overflow-hidden group">
                 ...
                 <p className="text-xs font-bold text-slate-500 uppercase tracking-wide">Fuel Reserves</p>
                 <div className="flex items-end justify-between">
                    <div><span className="text-3xl font-bold text-slate-900 dark:text-white">82%</span><span className="text-xs text-slate-400 ml-1">Capacity</span></div>
              ...
              <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between h-28 relative overflow-hidden group">
                 ...
                 <p className="text-xs font-bold text-slate-500 uppercase tracking-wide">Water Supply</p>
                 <div className="flex items-end justify-between">
                    <div><span className="text-3xl font-bold text-slate-900 dark:text-white">95%</span><span className="text-xs text-slate-400 ml-1">Capacity</span></div>
              ...
              <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between h-28 relative overflow-hidden group">
                 ...
                 <p className="text-xs font-bold text-slate-500 uppercase tracking-wide">Material Stock</p>
                 <div className="flex items-end justify-between">
                    <div><span className="text-3xl font-bold text-slate-900 dark:text-white">Good</span><span className="text-xs text-emerald-500 font-bold ml-1">Stable</span></div>
           ...
           <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
              <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                 <h3 className="font-bold text-sm text-slate-800 dark:text-white">Current Stock Level</h3>
                 <button className="text-xs font-bold text-indigo-600 hover:text-indigo-800 flex items-center gap-1">Full Report <ArrowRight size={12} /></button>
              </div>
           ...
           <div className="h-80 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden relative shadow-sm">
              <div className="absolute top-4 left-4 z-10 bg-white dark:bg-slate-900 px-3 py-1.5 rounded-lg text-xs font-bold shadow-sm border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300">Logistic Coverage Area</div>
              <AssetMap assets={assets} shorebases={shorebases} selectedAssetId={null} height="h-full" zoomLevel="region" showLogistics={true} />
           </div>
        </div>
      </div>

      <Modal isOpen={isTransferModalOpen} onClose={() => setIsTransferModalOpen(false)} title="Dispatch Logistics">
